...
const Smartphone = () => {
  ...
  const [screenContent, setScreenContent] = useState(
    "Welcome to the USSD Simulator. Tap to enter a code (e.g., *384#)."
  ); 
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await axios.post(
        `${BASE_URL}/api/v1/user/userResponse/collect?`,
        {},
        {
          params: {
            sessionId,
        ...
        >
          ...
          {showKeypad && (
            ...
            >
              ...
              >
                {(keypadMode === "numbers" ? numberKeys : letterKeys).map(
                  (key, index) => (
                    <div
                      key={index}
                      style={{
                      ...
                      onClick={() =>
                        keypadMode === "numbers" &&
                        handleKeyPress(numberKeys[index])
                      }
                    >
